...
class Locale {
	...
	// for toString() ...
	@:privateAccess() static var _key:String = "";
	@:privateAccess() static var _context:String = "";
	@:privateAccess() static var _values:Null<Array<Dynamic>> = [];
	...
	**/
	inline public static function getString(key:String, context:String = "data", ?values:Array<Dynamic>):String {
		_key = key; _context = context; _values = values;
