@{
	...
	Haxe            = @{
		NotFound = "Haxelib não foi encontrado!`n'%HAXEPATH%' e '%NEKO_INSTPATH%' estão registrados no PATH?"
		GetPath  = "Por favor, insira a localização da sua pasta HaxeToolkit."
	}
